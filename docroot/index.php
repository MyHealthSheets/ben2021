...
<body>
<div class="main">
	<nav class="navbar navbar-expand-sm navbar-dark " style="background-color:#697184">
	...
	<div class="jumbotron jumbrotron-fluid" style="border-radius:0px;border-top:2px solid #FF8D3F;padding-bottom:5rem;">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-3">
	   					<img src="images/me_transparent.PNG" width="375px" height="450px">
					</div>	
					<div class="col-lg-2"></div>
					<div class="col-lg-7 justify-content-center">
						<h1><b>Benjamin Citren</b></h1>
						<p class="lead"><b>Hello and welcome to my site! I created this to document some of the current as well as past technologies and projects
						I have worked on.
						</b></p>
<br>
					</div>
...
<div class="main-body">	    
    <div class="card">
	 ...
	 <div class="card-body">
	          <p>I have always been interesting in Electronics and Computers. It probably started in my pre-teens, taking apart mine (and my family's) Electronic Devices to try and understand them better.
	...
	<div class="card">
	  <div class="card-header">
	<button class="btn btn-link" data-toggle="collapse" data-target="#collapsePi"  aria-controls="collapsePi">
	<h3>Some more Recent Raspbery Pi Projects</h3>
	</div>
	<div class="card-body" id="collapsePi">
...
<!-- Go Raptors///////////////////////////////////////////////////////////////////////// -->
<div class="row justify-content-center" style="margin-top:10em;border-radius:10px">
	<div class="card" style="border: 2px solid #FF8D3F;border-radius:10px">
	        <img class="card-img" src="images/raps/rap_claw.PNG" alt="Raptors Image">
	    	<div class="card-img-overlay">
	        	<div class="card-text"> <h4 style="color:#FFF">GO RAPTORS!!!</h4>
			</div>
	    	</div>
	</div>
</div>

<?php include "home_tables.php"; ?>
